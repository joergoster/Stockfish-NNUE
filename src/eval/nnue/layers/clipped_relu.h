  ...
  namespace NNUE {
    namespace Layers {
      ...
      public:
        ...
        static constexpr std::size_t kSelfBufferSize =  CeilToMultiple(kOutputDimensions
                                                      * sizeof(OutputType), kCacheLineSize);
        ...
        static std::string GetStructureString() {
          return "ClippedReLU[" + std::to_string(kOutputDimensions) + "]("
        ...
        const OutputType* Propagate(const TransformedFeatureType* transformed_features,
          ...
          for (IndexType i = 0; i < kNumChunks; ++i)
          {
              ...
              _mm_store_si128(&out[i], _mm_max_epi8(_mm_packs_epi16(words0, words1), kZero));
          }
