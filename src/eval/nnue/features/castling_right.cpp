...
namespace Eval {
  namespace NNUE {
    namespace Features {
      ...
      void CastlingRight::AppendActiveIndices(const Position& pos, Color perspective,
                                              IndexList* active) {
        ...
        if (perspective == WHITE)
            ...
            relative_castling_rights = ((castling_rights & 3) << 2) & ((castling_rights >> 2) & 3);
      ...
      void CastlingRight::AppendChangedIndices(const Position& pos, Color perspective,
        ...
        {
            // Invert the perspective.
            relative_previous_castling_rights = ((previous_castling_rights & 3) << 2) & ((previous_castling_rights >> 2) & 3);
            relative_current_castling_rights  = ((current_castling_rights  & 3) << 2) & ((current_castling_rights  >> 2) & 3);
        }
